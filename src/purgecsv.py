...
def purgecsv(
    ...
    destination_dir: Annotated[
        str, typer.Argument(help="Destination directory used to move deplicated files"),
    ] = None,
):
    console = Console()
    ...
    if destination_dir is None or not os.path.exists(destination_dir) or not os.path.isdir(destination_dir):
        console.print("[red]Destination directory must be provided and must exist.[/red]")
